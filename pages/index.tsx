            ...
            <Col span={12} style={{padding: "0"}}>
              <div className='new-login-left-wrapper'>
               ...
               <div className='new-login-left-content'>
                <h1>Your culinary adventure<span style={{color:"black"}}> starts here.</span></h1>
                <p>Sign in and let’s cook something extraordinary together!</p>
               </div>
              </div>
            </Col>
            <Col span={12} style={{padding: "0"}}>
              <div style={{backgroundColor: "blue", height:"100%"}}>Login form</div>
            </Col>
          </Row>
          </div>
